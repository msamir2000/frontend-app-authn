...
import {
  LOGIN_PAGE, PAGE_NOT_FOUND, PASSWORD_RESET_CONFIRM, PROGRESSIVE_PROFILING_PAGE, REGISTER_PAGE, RESET_PAGE,
} from './data/constants';
...
const MainApp = () => (
  <AppProvider store={configureStore()}>
    ...
    <Switch>
      ...
      <Route exact path={PROGRESSIVE_PROFILING_PAGE} component={ProgressiveProfiling} />
